...
- **Changed Files**:
  ...
  - `Untracked M1 records (never staged): docs/tasks/TASK-2026-09-17-core-ledger.checkpoint-01.md, .handoff-01.md`
...
- **CI Evidence**: `N/A`
- **Review / Commit / PR Evidence**: `bcf62fa + 539de27 local; no PR (no remote)`
